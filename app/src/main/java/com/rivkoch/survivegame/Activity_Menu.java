package com.rivkoch.survivegame;
    ...
    private void initViews() {
            ...
            this.menu_BTN_start.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    String str = menu_EDT_id.getText().toString();
                    if(str.length() != 9) {
                        Toast.makeText(Activity_Menu.this, "Id must include 9 numbers !", Toast.LENGTH_LONG).show();
                    }
                    else {
